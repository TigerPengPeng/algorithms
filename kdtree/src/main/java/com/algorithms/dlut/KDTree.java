...
import com.algorithms.dlut.exceptions.KeyDuplicateException;
import com.algorithms.dlut.exceptions.KeyMissingException;
import com.algorithms.dlut.exceptions.KeySizeException;
...
public class KDTree<T> {
    ...
    *
    * @throws com.algorithms.dlut.exceptions.KeySizeException if key.length mismatches K
    * @throws com.algorithms.dlut.exceptions.KeyDuplicateException if key already in tree
    */
